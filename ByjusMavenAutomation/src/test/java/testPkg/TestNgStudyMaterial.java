...
public class TestNgStudyMaterial {
	...
	@Test
	public void checkOnAdditionalCalci() throws InterruptedException
	{
       ...
       // studyMaterialPage.clickOnStudyMaterial();
		...
		String expUrl="https://byjus.com/calculators/";
		String expTitle="Free Online Calculators - Online Math, Physics, Chemistry Calculators";
